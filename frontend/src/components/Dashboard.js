...
import AyamIndukModule from './modules/AyamIndukModule';
import BreedingModule from './modules/BreedingModule';
import AyamAnakanModule from './modules/AyamAnakanModule';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Sistem Manajemen Profesional</p>
              </div>
            </div>
